...
class MessageAction(Component):
    ...
    def package_not_allowed_in_src_location(self, barcode, picking_types):
        return {
            "message_type": "error",
            "body": _(
                "You cannot work on a package (%(barcode)s) "
                + "outside of locations: %(loc_dest_name)s"
            )
            % (
                barcode,
    ...
    def confirm_location_changed(self, from_location, to_location):
        return {
            "message_type": "warning",
            "body": _("Confirm location change from %(from)s to %(to)s?")
    ...
    def several_packs_in_location(self, location):
        return {
            "message_type": "warning",
            "body": _("Several packages found in %(locaction)s, please scan a package.")
            % location.name,
        }
    ...
    def several_lots_in_location(self, location):
        return {
            "message_type": "warning",
            "body": _("Several lots found in %(location)s, please scan a lot.")
            % location.name,
        }
    ...
    def several_products_in_location(self, location):
        return {
            "message_type": "warning",
            "body": _("Several products found in %(location)s, please scan a product.")
            % location.name,
        }
